...
public class Deer extends Herbivore {
    ...
    public Deer() {
        super(
                ConfigLoader.getDoubleProperty("deer.weight"),
                ConfigLoader.getIntProperty("deer.maxCountPerLocation"),
                ConfigLoader.getIntProperty("deer.maxSpeed"),
                ConfigLoader.getDoubleProperty("deer.foodRequired")
        );
    }
    ...
    public void eat(Location location) {
        for (Plant plant : location.getPlants()) {
            ...
            notifier.notifyInfo("Deer ate a plant");
            break;
        }
    ...
    public void move(Island island) {
        ...
        notifier.notifyInfo("Deer moved to (" + x + ", " + y + ")");
    }
